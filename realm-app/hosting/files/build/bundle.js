...
var app = (function () {
    ...
    const file$1 = "src/Letter.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "--letter-color", "var(--color-" + /*color*/ ctx[0] + ")");
    			attr_dev(div0, "class", "letter svelte-b20lqa");
    			add_location(div0, file$1, 13, 2, 287);
    			attr_dev(button0, "class", "absent svelte-b20lqa");
    			button0.disabled = button0_disabled_value = !!/*frozen*/ ctx[2];
    			add_location(button0, file$1, 17, 4, 410);
    			attr_dev(button1, "class", "present svelte-b20lqa");
    			button1.disabled = button1_disabled_value = !!/*frozen*/ ctx[2];
    			add_location(button1, file$1, 18, 4, 501);
    			attr_dev(button2, "class", "correct svelte-b20lqa");
    			button2.disabled = button2_disabled_value = !!/*frozen*/ ctx[2];
    			add_location(button2, file$1, 19, 4, 594);
    			attr_dev(div1, "class", "color-selector svelte-b20lqa");
    			add_location(div1, file$1, 16, 2, 377);
    			attr_dev(div2, "class", "letter-wrapper svelte-b20lqa");
    			add_location(div2, file$1, 12, 0, 256);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*frozen*/ 4 && button0_disabled_value !== (button0_disabled_value = !!/*frozen*/ ctx[2])) {
    				prop_dev(button0, "disabled", button0_disabled_value);
    			}

    			if (dirty & /*frozen*/ 4 && button1_disabled_value !== (button1_disabled_value = !!/*frozen*/ ctx[2])) {
    				prop_dev(button1, "disabled", button1_disabled_value);
    			}

    			if (dirty & /*frozen*/ 4 && button2_disabled_value !== (button2_disabled_value = !!/*frozen*/ ctx[2])) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { color, letter, frozen } = $$props;
    	const dispatch = createEventDispatcher();

    	function setColor(theColor) {
    		$$invalidate(0, color = theColor);
    		dispatch('colorchange', { color: theColor });
    	}

    	const writable_props = ['color', 'letter', 'frozen'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Letter> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => setColor('absent');
    	const click_handler_1 = () => setColor('present');
    	const click_handler_2 = () => setColor('correct');

    	$$self.$$set = $$props => {
    		if ('color' in $$props) $$invalidate(0, color = $$props.color);
    		if ('letter' in $$props) $$invalidate(1, letter = $$props.letter);
    		if ('frozen' in $$props) $$invalidate(2, frozen = $$props.frozen);
    	};
    ...
    class Letter extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { color: 0, letter: 1, frozen: 2 });
    		...
    		if (/*color*/ ctx[0] === undefined && !('color' in props)) {
    			console.warn("<Letter> was created without expected prop 'color'");
    		}
    		...
    		if (/*frozen*/ ctx[2] === undefined && !('frozen' in props)) {
    			console.warn("<Letter> was created without expected prop 'frozen'");
    		}
    	}
    ...
    ***************************************************************************** */
    ...
    var Realm = /*#__PURE__*/Object.freeze({
        __proto__: null,
        BSON: bson_browser_esm,
        App: App$1,
        Credentials: Credentials,
        DEFAULT_BASE_URL: DEFAULT_BASE_URL,
        LocalStorage: LocalStorage,
        MongoDBRealmError: MongoDBRealmError,
        User: User,
        get UserState () { return UserState; },
        get UserType () { return UserType$1; },
        getApp: getApp,
    ...
    // (1:0) <script>  import Letter from './Letter.svelte';  import Wordle from './wordle';  import * as Realm from "realm-web";    const w = new Wordle();  const app = new Realm.App({ id: 'wordle-gvqgy' }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>  import Letter from './Letter.svelte';  import Wordle from './wordle';  import * as Realm from \\\"realm-web\\\";    const w = new Wordle();  const app = new Realm.App({ id: 'wordle-gvqgy' }",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*nextDisabled, getNextWord, words, colorChanged*/ 27) {
    ...
    // (51:5) {#each word.map(({letter}) => letter) as l, position}
    function create_each_block_1(ctx) {
    	let letter;
    	let current;

    	function colorchange_handler(...args) {
    		return /*colorchange_handler*/ ctx[5](/*position*/ ctx[16], ...args);
    	}
    	...
    	letter = new Letter({
    			props: {
    				letter: /*l*/ ctx[14],
    				color: "",
    				frozen: /*i*/ ctx[13] < /*words*/ ctx[0].length - 1
    			},
    			$$inline: true
    		});

    	letter.$on("colorchange", colorchange_handler);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*words*/ 1) letter_changes.letter = /*l*/ ctx[14];
    			if (dirty & /*words*/ 1) letter_changes.frozen = /*i*/ ctx[13] < /*words*/ ctx[0].length - 1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:5) {#each word.map(({letter}) => letter) as l, position}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*word*/ ctx[11].map(func);
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("Next Word");
    			t2 = space();
    			attr_dev(div0, "class", "word svelte-93nyvd");
    			add_location(div0, file, 49, 4, 1313);
    			attr_dev(button, "class", "next svelte-93nyvd");
    			button.disabled = /*nextDisabled*/ ctx[1];
    			add_location(button, file, 54, 4, 1566);
    			attr_dev(div1, "class", "entry svelte-93nyvd");
    			add_location(div1, file, 48, 3, 1289);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*getNextWord*/ ctx[4], { once: true }, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*words, colorChanged*/ 9) {
    				each_value_1 = /*word*/ ctx[11].map(func);
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (!current || dirty & /*nextDisabled*/ 2) {
    				prop_dev(button, "disabled", /*nextDisabled*/ ctx[1]);
    			}
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:2) {#each words as word, i}",
    		ctx
    	});
    ...
    // (45:23)    <p class="loader">Setting things up...</p>  {:then _}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Setting things up...";
    			attr_dev(p, "class", "loader svelte-93nyvd");
    			add_location(p, file, 45, 2, 1204);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(45:23)    <p class=\\\"loader\\\">Setting things up...</p>  {:then _}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "No matching words found";
    			attr_dev(p, "class", "noword svelte-93nyvd");
    			add_location(p, file, 59, 2, 1704);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*getNextWord*/ ctx[4](), info);
    	let if_block = /*noword*/ ctx[2] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 43, 0, 1171);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const func = ({ letter }) => letter;

    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('App', slots, []);
    	const w = new Wordle();
    	const app = new App$1({ id: 'wordle-gvqgy' });
    	...
    	function colorChanged(position, color) {
    		$$invalidate(0, words[words.length - 1][position].color = Wordle.COLOR[color], words);
    		$$invalidate(1, nextDisabled = !nextEnabled());
    	}

    	function nextEnabled() {
    		return words[words.length - 1].filter(l => l.color === undefined).length === 0 && words[words.length - 1].filter(l => l.color === Wordle.COLOR.correct).length < 5;
    	}
    	...
    	async function getNextWord() {
    		...
    		try {
    			...
    			$$invalidate(0, words = [...words, word.split('').map(letter => ({ letter }))]);
    			return words;
    		} catch {
    			$$invalidate(2, noword = true);
    		}
    	}
    	...
    	const colorchange_handler = (position, event) => colorChanged(position, event.detail.color);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('nextDisabled' in $$props) $$invalidate(1, nextDisabled = $$props.nextDisabled);
    		if ('noword' in $$props) $$invalidate(2, noword = $$props.noword);
    	};
    	...
    	return [words, nextDisabled, noword, colorChanged, getNextWord, colorchange_handler];
    }
