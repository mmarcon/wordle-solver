    ...
    ***************************************************************************** */
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*nextDisabled, getNextWord, words, colorChanged*/ 15) {
    ...
    function create_each_block_1(ctx) {
    	...
    	function colorchange_handler(...args) {
    		return /*colorchange_handler*/ ctx[4](/*position*/ ctx[14], ...args);
    	}
    	...
    	letter = new Letter({
    			props: {
    				letter: /*l*/ ctx[12],
    				color: "",
    				frozen: /*i*/ ctx[11] < /*words*/ ctx[0].length - 1
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*words*/ 1) letter_changes.letter = /*l*/ ctx[12];
    			if (dirty & /*words*/ 1) letter_changes.frozen = /*i*/ ctx[11] < /*words*/ ctx[0].length - 1;
    ...
    function create_each_block(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*word*/ ctx[9].map(func);
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("Next Word");
    			t2 = space();
    			attr_dev(div0, "class", "word svelte-mfb9xn");
    			add_location(div0, file, 49, 4, 1227);
    			attr_dev(button, "class", "next svelte-mfb9xn");
    			button.disabled = /*nextDisabled*/ ctx[1];
    			add_location(button, file, 54, 4, 1480);
    			attr_dev(div1, "class", "entry svelte-mfb9xn");
    			add_location(div1, file, 48, 3, 1203);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*getNextWord*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*words, colorChanged*/ 5) {
    				each_value_1 = /*word*/ ctx[9].map(func);
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "loader svelte-mfb9xn");
    			add_location(p, file, 45, 2, 1118);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*getNextWord*/ ctx[3](), info);
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			info.block.c();
    			add_location(style, file, 36, 1, 1008);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [words, nextDisabled, colorChanged, getNextWord, colorchange_handler];
    }
